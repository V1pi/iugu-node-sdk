...
class IuguAccounts extends IuguCommon<IuguInfoAccount> {
  async requestVerification (data: string | object, urlParams: Map<string, string> | undefined): Promise<IuguVerificationAccount> {
  ...
  async requestWithdraw (data: string | object, urlParams: Map<string, string> | undefined): Promise<IuguWithdrawRequest> {
  ...
  async requestConfiguration (data: string | object, urlParams: Map<string, string> | undefined): Promise<IuguConfigAccount> {
